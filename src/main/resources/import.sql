...
insert into clientes (nombre,apellido,email,create_at,foto) values ('Diego','Zubaray','diego@gmail.com','1987-03-07','');
insert into clientes (nombre,apellido,email,create_at,foto) values ('Agus','Zubaray','agus@gmail.com','2005-07-18','');
insert into clientes (nombre,apellido,email,create_at,foto) values ('Benja','Zubaray','benja@gmail.com','2009-09-07','');
INSERT INTO clientes (nombre, apellido, email, create_at,foto) VALUES('Carlos', 'Gomez', 'carlos@gomez.com', '2017-08-01','');
...
INSERT INTO productos (nombre, precio, create_at) VALUES('Celular Samsung A20', 299990, NOW());
...
/* Algunos usuarios con sus roles */
INSERT INTO `users` (username, password, enabled) VALUES ('diego','$2a$10$1SiAZUOM91T2yIB2jWBbY.RGqBaxgQ2s6.zGGvbEJylbeYx7vrIUq',1);
INSERT INTO `users` (username, password, enabled) VALUES ('admin','$2a$10$nc9R8FGz40ETkoAL0FOdmuNfU7/8qlU7uJJtnbP967FLprlFd89SO',1);
